...
export const createApiKey = (orgId, data) => api.post(`/organizations/${orgId}/api-keys`, data);
export const getApiKey = (orgId, keyId) => api.get(`/organizations/${orgId}/api-keys/${keyId}`);
